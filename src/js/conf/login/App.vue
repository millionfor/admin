<template>
  <div class="wrapper">
    ...
    <div class="login-box" id="app" >
      ...
      <el-row>
        <el-col :span="12">
          <el-button @click="onSubmit" style="width:100%" type="primary" :loading="loading">登录</el-button>
        </el-col>
      </el-row>
    </div>
  </div>
...
<style lang="scss" rel="stylesheet/scss">
  body{
    ...
    background-image: url(http://img1.quanquansy.com/landscapes/1549472303000/IMG_8295.jpg);
